...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Xếp hạng", "fieldname": "ranking", "fieldtype": "Data", 'dropdown': False, 'sortable': False, "width": 140},
        {"label": "Đánh giá sau sử dụng", "fieldname": "post_usage_review", "fieldtype": "Data", 'dropdown': False, 'sortable': False, "width": 300},
    ]
